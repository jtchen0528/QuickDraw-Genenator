...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', '-s', type=str,
                        default='./Trained_Models', help='directory for saving checkpoints')
    ...
    with open("./" + args.save_dir + "/train_loss.txt", "w") as output:
        output.write(str(Train_Loss))

    with open("./" + args.save_dir + "/test_loss.txt", "w") as output:
